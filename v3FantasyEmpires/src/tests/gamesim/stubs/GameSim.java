...
public class GameSim extends code.GameSim {
	 ...
	 * Stop before the given number of steps if it ceases to be viable. DON'T
	 * USE FOR PLAYING
	 * 
	 * @param numSteps
	...
	public void simulateOneStep() {
		...
		for (Iterator<code.Civilization> it = world.getCivs().iterator(); it
				.hasNext();) {
			code.Civilization civ = it.next();
